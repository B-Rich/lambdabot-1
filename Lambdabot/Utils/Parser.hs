...
module Lambdabot.Utils.Parser (parseExpr, parseDecl, withParsed, prettyPrintInLine) where
...
import Lambdabot.Utils.FixPrecedence
...
parseExpr s
    ...
    | otherwise          = case parseModule wrapped of
        ...
        _ -> Left $ "Unexpected result of parsing an expression"
  where
...
parseDecl s = case parseModule s of
        ...
        _                                -> Left $ "Unexpected result of parsing a declaration"
